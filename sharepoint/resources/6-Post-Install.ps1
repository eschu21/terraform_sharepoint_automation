...
$env:userdnsdomain = 'ibmsarmy.mil'
...
$creds = New-Object System.Management.Automation.PSCredential ("$secusername", $encryptedpw)
...
New-SPSecureStoreServiceApplication -ApplicationPool $AppPool.Name -AuditingEnabled:$false -DatabaseServer $ServerName -DatabaseName "sp.SecureStore" -Name "Secure Store"
